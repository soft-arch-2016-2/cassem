...
public class AccessCarTest {
  ...
  @Test
  public void testAccessCar() throws Exception {
    ...
    driver.get("http://localhost:8080/cassem/faces/createCar.xhtml");
    assertEquals(driver.getTitle(), "Cassem");
  }
